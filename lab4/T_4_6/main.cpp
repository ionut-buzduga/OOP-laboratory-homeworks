...
public:
	...
	void getMaxGradeStudent() {
		sortStudentGroup();

		cout << "Student with the highest grade is:\n";
		cout << studentsList.back().getName() << " " << studentsList.back().getNote() << "\n";
	}
...
int main()
{
	...
	Student F = studentsGroup->firstFive();
	cout << "First student with the grade 5 is:\n";
	cout << F.getName() << " " << F.getNote() << "\n";
